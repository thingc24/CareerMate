    ...
    return (
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="text-center py-12">
          ...
          <p className="mt-4 text-gray-600 dark:text-gray-300 font-medium">Đang tải danh sách công ty...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="max-w-7xl mx-auto px-4 py-4">
      ...
      {companies.length === 0 ? (
        <div className="card p-16 text-center shadow-lg dark:bg-gray-900 dark:border-gray-800">
          ...
          <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Không tìm thấy công ty nào</h3>
          <p className="text-gray-600 dark:text-gray-400">Thử tìm kiếm với từ khóa khác hoặc xem tất cả công ty</p>
        </div>
      ) : (
        <>
            ...
            {companies.map((company, index) => (
              ...
              >
                ...
                {company.logoUrl ? (
                  <div className="mb-4 flex justify-center">
                    <div className="relative">
                      <img
                        ...
                        alt={company.name}
                        className="h-24 w-24 object-contain rounded-lg border-2 border-gray-100 dark:border-gray-800 group-hover:border-blue-300 dark:group-hover:border-blue-600 transition-all duration-300 p-2 bg-white dark:bg-gray-900"
                        onError={(e) => {
                  ...
                  <div className="mb-4 flex justify-center">
                    <div className="h-24 w-24 rounded-lg bg-gradient-to-br from-blue-100 to-indigo-100 dark:from-gray-800 dark:to-gray-800 flex items-center justify-center border-2 border-gray-100 dark:border-gray-800 group-hover:border-blue-300 dark:group-hover:border-blue-600 transition-all">
                      <i className="fas fa-building text-blue-500 dark:text-blue-400 text-3xl"></i>
                    </div>
                  </div>
                )}
                ...
                {company.industry && (
                  <div className="flex items-center gap-2 mb-2">
                    <div className="flex items-center justify-center w-6 h-6 rounded-full bg-blue-100 dark:bg-gray-800 text-blue-600 dark:text-blue-400">
                ...
                {company.headquarters && (
                  <div className="flex items-center gap-2 mb-4">
                    <div className="flex items-center justify-center w-6 h-6 rounded-full bg-green-100 dark:bg-gray-800 text-green-600 dark:text-green-400">
                      <i className="fas fa-map-marker-alt text-xs"></i>
                    </div>
                    <span className="text-sm text-gray-600 dark:text-gray-400">{company.headquarters}</span>
                  </div>
                )}
                ...
                {/* View Details CTA */}
                <div className="mt-4 pt-4 border-t border-gray-100 dark:border-gray-800">
                  <div className="flex items-center justify-between text-sm text-blue-600 dark:text-blue-400 group-hover:text-blue-700 dark:group-hover:text-blue-300 font-medium">
          ...
          {totalPages > 1 && (
            <div className="flex justify-center items-center gap-3">
              <button
                ...
                disabled={page === 0}
                className="px-4 py-2 bg-white dark:bg-gray-900 dark:text-white border-2 border-gray-200 dark:border-gray-800 rounded-lg hover:border-blue-500 dark:hover:border-blue-500 hover:bg-blue-50 dark:hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center gap-2"
              >
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg font-medium transition-all duration-200 ${
                      page === i
                        ...
                        : 'bg-white dark:bg-gray-900 dark:text-white border-2 border-gray-200 dark:border-gray-800 text-gray-700 dark:text-gray-300 hover:border-blue-300 dark:hover:border-blue-600 hover:bg-blue-50 dark:hover:bg-gray-800'
                    }`}
                  >
                    {i + 1}
                  </button>
