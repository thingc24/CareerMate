      ...
      {activeTab === 'badges' ? (
        <div>
          {myBadges.length === 0 ? (
            <div className="card p-12 text-center">
              <i className="fas fa-medal text-gray-400 text-6xl mb-4"></i>
              <p className="text-gray-600 text-lg">Bạn chưa có huy hiệu nào</p>
              <p className="text-gray-500 text-sm mt-2">Hoàn thành thử thách để nhận huy hiệu!</p>
            </div>
          ) : (
        ...
        <>
          ...
          {(activeTab === 'all' ? challenges : myChallenges.map(c => c.challenge)).length === 0 ? (
            <div className="card p-12 text-center">
              <i className="fas fa-tasks text-gray-400 text-6xl mb-4"></i>
