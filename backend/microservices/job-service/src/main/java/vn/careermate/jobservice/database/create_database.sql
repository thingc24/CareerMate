...
DROP DATABASE IF EXISTS job_service_db;
...
GRANT ALL PRIVILEGES ON DATABASE job_service_db TO postgres;

-- Set default schema
ALTER DATABASE job_service_db SET search_path TO jobservice, public;
