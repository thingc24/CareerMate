...
public class NotificationService {
    ...
    public void notifyAllUsersAboutNewArticle(UUID articleId, String articleTitle) {
        try {
            // Lấy tất cả users có role STUDENT hoặc RECRUITER
            List<User> users = userRepository.findByRoleIn(
                List.of(User.UserRole.STUDENT, User.UserRole.RECRUITER)
            );
    ...
    public void notifyAdminsAboutPendingArticle(UUID articleId, String articleTitle, String authorName) {
        try {
            ...
            List<User> admins = userRepository.findByRoleIn(List.of(User.UserRole.ADMIN));
