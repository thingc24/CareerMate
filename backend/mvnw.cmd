...
:wrapperError
echo.
echo ERROR: Maven wrapper not found in %MAVEN_PROJECTBASEDIR%\.mvn\wrapper\maven-wrapper.jar
echo.
echo Please download the Maven wrapper jar from:
echo https://repo.maven.apache.org/maven2/org/apache/maven/wrapper/maven-wrapper/3.2.0/maven-wrapper-3.2.0.jar
echo and place it in %MAVEN_PROJECTBASEDIR%\.mvn\wrapper\maven-wrapper.jar
echo.
goto error
